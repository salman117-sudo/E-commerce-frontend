...
//       <h2 className="text-[24px] font-bold font-satoshi">Order Summary</h2>
...
//       {discountPercent > 0 && (
//         <div className="flex justify-between text-sm">
//           <span className="text-gray-500 font-satoshi">Discount (-{discountPercent}%)</span>
//           <span className="font-bold text-red-500 font-satoshi">-${discountAmount}</span>
//         </div>
//       )}
...
//       <div className="flex justify-between text-base font-bold font-satoshi">
//         <span>Total</span>
//         <span>${total}</span>
//       </div>
...
//           value={promoCode}
//           onChange={(e) => setPromoCode(e.target.value)}
//           className="flex-1 rounded-full border border-gray-200 font-satoshi bg-gray-50 px-4 py-2 text-sm outline-none"
//         />
//         <button
//           onClick={handleApply}
//           className="bg-black text-white rounded-full px-5 py-2 text-sm font-satoshi font-medium hover:bg-gray-800 transition-colors"
//         >
//           Apply
//         </button>
//       </div>

//       <button className="w-full bg-black text-white rounded-full py-3 font-medium font-satoshi hover:bg-gray-800 transition-colors flex items-center justify-center gap-2">
//         Go to Checkout <span>→</span>
//       </button>
//     </div>
//   )
